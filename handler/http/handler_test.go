...
func TestHandler_handleRoute(t *testing.T) {
	tt := []struct {
...

		{
			...
			auth:          &testingH.AuthenticationMock{},
			guard:         &testingH.GuardMock{},
			reqURLSuffix:  "/" + config.VersionMajor + "/" + config.Name + "/status",
		...
		},
		{
			...
			auth:          &testingH.AuthenticationMock{},
			guard:         &testingH.GuardMock{},
			reqURLSuffix:  "/" + config.VersionMajor + "/" + config.Name + "/first_user",
		...
		},
		{
			...
			auth:          &testingH.AuthenticationMock{},
			guard:         &testingH.GuardMock{},
			reqURLSuffix:  "/" + config.VersionMajor + "/" + config.Name + "/_loginType_/register",
			reqMethod:     http.MethodPut,
			reqBody:       "{}",
			expStatusCode: http.StatusCreated,
		},
		...
		},
		{
			...
			guard:         &testingH.GuardMock{ExpAPIKValidUsrID: "12345"},
			reqURLSuffix:  "/" + config.VersionMajor + "/" + config.Name + "/_loginType_/register?selfReg=true",
			reqMethod:     http.MethodPut,
			reqBody:       "{}",
			expStatusCode: http.StatusInternalServerError,
		},
		{
			...
			guard:         &testingH.GuardMock{ExpAPIKValidUsrID: "12345"},
			reqURLSuffix:  "/" + config.VersionMajor + "/" + config.Name + "/_loginType_/register?selfReg=device",
			reqMethod:     http.MethodPut,
			reqBody:       "{}",
			expStatusCode: http.StatusInternalServerError,
		},
		...
		},
		{
			...
			auth:          &testingH.AuthenticationMock{},
			guard:         &testingH.GuardMock{},
			reqURLSuffix:  "/" + config.VersionMajor + "/" + config.Name + "/_loginType_/login",
		...
		},
		{
			...
			auth:          &testingH.AuthenticationMock{},
			guard:         &testingH.GuardMock{},
			reqURLSuffix:  "/" + config.VersionMajor + "/" + config.Name + "/_loginType_/update",
			reqMethod:     http.MethodPost,
			reqBody:       "{}",
			expStatusCode: http.StatusOK,
		},
		...
		},
		{
			...
			auth:          &testingH.AuthenticationMock{},
			guard:         &testingH.GuardMock{},
			reqURLSuffix:  "/" + config.VersionMajor + "/" + config.Name + "/_loginType_/verify/address",
			reqMethod:     http.MethodGet,
			expStatusCode: http.StatusOK,
		},
		{
		...
		},
		{
			...
			auth:          &testingH.AuthenticationMock{},
			guard:         &testingH.GuardMock{},
			reqURLSuffix:  "/" + config.VersionMajor + "/" + config.Name + "/users/_userID_/verify/_dbToken_",
			reqMethod:     http.MethodGet,
			expStatusCode: http.StatusOK,
		},
		{
		...
		},
		{
			...
			guard:         &testingH.GuardMock{ExpAPIKValidUsrID: "12345"},
			reqURLSuffix:  "/" + config.VersionMajor + "/" + config.Name + "/users/_userID_/verify/_dbToken_?extend=true",
			reqMethod:     http.MethodGet,
			expStatusCode: http.StatusInternalServerError,
		},
		{
			...
			auth:          &testingH.AuthenticationMock{},
			guard:         &testingH.GuardMock{},
			reqURLSuffix:  "/" + config.VersionMajor + "/" + config.Name + "/reset_password/send_otp",
			reqMethod:     http.MethodPost,
			reqBody:       "{}",
			expStatusCode: http.StatusOK,
		},
		...
		},
		{
			...
			auth:          &testingH.AuthenticationMock{},
			guard:         &testingH.GuardMock{},
			reqURLSuffix:  "/" + config.VersionMajor + "/" + config.Name + "/reset_password",
			reqMethod:     http.MethodPost,
			reqBody:       "{}",
			expStatusCode: http.StatusOK,
		},
