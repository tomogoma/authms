      ...
      "fields": {
        "URL Query Parameters": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "group",
            "description": "<p>Filter by group name. one can have multiple groups e.g. ?group=admin&amp;group=staff</p>"
          },
          {
            "group": "URL Query Parameters",
            "type": "String",
            ...
            "optional": true,
            "field": "acl",
            "description": "<p>Filter by access levels:</p> <ul> <li>gt[number] - access level greater than number e.g. gt5</li> <li>lt[number] - access level less than number e.g. lt5</li> <li>[number] - access level equal to number e.g. 5</li> <li>gteq[number] - access level greater than or equal to number e.g. gteq5</li> <li>gteq[number] - access level less than or equal to  number e.g. lteq5</li> <li>one can have multiple filters e.g. ?acl=gt5&amp;acl=lt9&amp;acl=9.5 to get acl in (acl==9.5 || 5 &lt; acl &lt; 9)</li> </ul>"
          }
        ]
      }
    },
      ...
      "fields": {
        ...
        "JSON Request Body": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "secret",
            "description": "<p>The user's password - required when selfReg not set.</p>"
          },
          {
            "group": "JSON Request Body",
            "type": "String",
